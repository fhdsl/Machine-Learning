...
Let's load in our high dimensional gene expression - vitamin A production rate back in. We will construct a neural network with all of the genes are predictors, have a hidden layer size of 200, and predict the production of vitamin A.
...
That's pretty terrible performance!
