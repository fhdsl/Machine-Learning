...
*Can we use RNA gene expression predict downstream phenotype?* We look at bacterial cultures of *Bacillus subtilis* to see whether we can use its gene expression levels to predict its riboflavin (Vitiman A) production.
...
Our response corresponds to log-transformed riboflavin (vitamin B2) production rate of Bacillus subtilis.
...
riboflavin_expression_train, riboflavin_expression_test = train_test_split(riboflavin_expression, test_size=0.2, random_state=42)
```
...
You will explore this in your exercise for this week!
