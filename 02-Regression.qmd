...
In a prediction model, the outcome is continuous. Instead of yes/no for $Hyptertension$, we will use the clinical metric to $BloodPressure$, which is a formula based on \_\_\_\_. The prediction model we will use is called a **Linear Model**, in its basic form draws a straight line as a line of "best fit" for given the data.
